 ...
 * @since 2018/10/13
 */
public class MacTestCreateEvent extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        try {
            ...
            ResponseEntity<String> responseEntity=restTemplate.
                    postForEntity("http://10.50.8.132:8083/serviceEvent/event/addSealedEvent",requestEntity,String.class);
            ...
            if (1 == code){
                ...
                responseEntity=restTemplate.
                        postForEntity("http://10.50.8.132:8083/serviceEvent/event/confirmSend?eventNo="+eventNo,requestEntity,String.class);
    ...
    public static void main(String[] args) {
        MacTestCreateEvent tets = new MacTestCreateEvent();
