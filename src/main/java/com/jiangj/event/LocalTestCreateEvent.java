    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        try {
            ...
            ResponseEntity<String> responseEntity=restTemplate.
                    postForEntity("http://127.0.0.1:8083/serviceEvent/event/addSealedEvent",requestEntity,String.class);
            ...
            if (1 == code){
                ...
                responseEntity=restTemplate.
                        postForEntity("http://127.0.0.1:8083/serviceEvent/event/confirmSend?eventNo="+eventNo,requestEntity,String.class);
