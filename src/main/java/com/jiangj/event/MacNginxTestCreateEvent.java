 ...
 * @since 2018/10/13
 */
public class MacNginxTestCreateEvent extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        try {
            ...
            ResponseEntity<String> responseEntity=restTemplate.
                    postForEntity("http://10.50.8.132"+Constants.ADD_EVENT,requestEntity,String.class);
...
//                //System.out.println(responseEntity.getBody());
    ...
    public static void main(String[] args) {
        MacNginxTestCreateEvent tets = new MacNginxTestCreateEvent();
