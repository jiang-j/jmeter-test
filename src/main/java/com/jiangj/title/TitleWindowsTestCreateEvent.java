 ...
 * @since 2018/10/13
 */
public class TitleWindowsTestCreateEvent extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        try {
            ...
            ResponseEntity<String> responseEntity=restTemplate.
                    getForEntity("http://10.50.8.133:6060/ms/api/v1/title/search?name=四川",String.class);
    ...
    public static void main(String[] args) {
        TitleWindowsTestCreateEvent tets = new TitleWindowsTestCreateEvent();
